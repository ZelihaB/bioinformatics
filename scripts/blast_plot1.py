...
blast_G_muris = pd.read_csv('/Users/zabc/Documents/bioinformatics/output/blastn/G_intertinalis/G_muris.blastn', sep='\t', header=None)
blast_S_salmonicida = pd.read_csv('/Users/zabc/Documents/bioinformatics/output/blastn/G_intertinalis/S_salmonicida.blastn', sep='\t', header=None)
