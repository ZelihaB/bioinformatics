...
tie %Config, 'Config', {
    ...
    libpth => "$compilerroot/lib/clang/15.0.7/lib $sdkroot/usr/lib",
    osname => 'darwin',
    osvers => '20.6.0',
    path_sep => ':',
    privlibexp => relocate_inc('.../../lib/perl5/core_perl'),
    scriptdir => '/Users/zabc/Documents/bioinformatics/.snakemake/conda/63348352802c7b3b8e5634afb1b79114_/bin',
